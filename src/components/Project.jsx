...
import imgmovieapp from "../components/image/imgmovieapp.png"
...
const Project=()=>{
    const Projects=[
        ...
        },
        {
            ...
            src:imgmovieapp,
            githublink:"https://github.com/jagtapnimisha2/Movie_App",
            link:"https://main--willowy-donut-81fdb4.netlify.app/"

        },
        {
            id:3,
            project_name:"IOT Based Smart Garbage Monitoring System",
            src:imag17,
        ...
        {
            id:4,
            project_name:"ineuron-assignment--1",
            src:imag15,
        ...
        {
            id:5,
            project_name:"ineuron-assignment--2",
            src:imag14,
        ...
        {
            id:6,
            project_name:"ineuron-assignment--3",
            src:imag13,
        ...
        {
            id:7,
            project_name:"ineuron-assignment--4",
            src:imag12,
        ...
        {
            id:8,
            project_name:"ineuron-assignment--5",
            src:imag11,
        ...
        {
            id:9,
            project_name:"ineuron-assignment--6",
            src:imag10,
        ...
        {
            id:10,
            project_name:"ineuron-assignment--7",
            src:imag9,
        ...
        {
            id:11,
            project_name:"ineuron-assignment--8",
            src:imag8,
        ...
        {
            id:12,
            project_name:"ineuron-assignment--9",
            src:imag7,
        ...
        {
            id:13,
            project_name:"ineuron-assignment--10",
            src:imag6,
        ...
        {
            id:14,
            project_name:"ineuron-assignment--11",
              src:imag5,
        ...
        {
            id:15,
            project_name:"ineuron-assignment--12",
            src:imag4,
        ...
        {
            id:16,
            project_name:"ineuron-assignment--13",
            src:imag3,  
        ...
        {
            id:17,
            project_name:"ineuron-assignment--14",
            src:imag2,
        ...
        {
            id:18,
            project_name:"ineuron-assignment--15",
            src:imag1,
    ...
    ">
        <div className="pb-8">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3  text-center gap-8 px-12 sm:px-0">
            {
                ...
                Projects.map(({id,project_name,src,githublink,link})=>(
